    ...
    <main className="flex min-h-screen flex-col items-center p-4 sm:p-8 md:p-24 bg-gradient-to-b from-background to-muted">
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <p className="mb-6 text-lg text-muted-foreground">
          Our AI text to infographic tool offers multiple size options to fit your specific needs,
          whether you're creating content for presentations, documents, or mobile viewing.
        </p>
        ...
        <div className="space-y-12 mb-16">
          <div className="glass-card p-8 card-shadow">
            ...
            <p className="text-muted-foreground mb-4">
              Perfect for slide presentations, this widescreen format (1920×1080 pixels) ensures
              your infographic looks great when projected or shared on screens. Ideal for business
              presentations, lectures, and online webinars.
            </p>
          ...
          <div className="glass-card p-8 card-shadow">
            ...
            <p className="text-muted-foreground mb-4">
              Designed for printing, this format (297×210 mm) is perfect for handouts, reports, and
              printed materials. The landscape orientation provides more horizontal space for
          ...
          <div className="glass-card p-8 card-shadow">
            ...
            <p className="text-muted-foreground mb-4">
              Our mobile-optimized format (750px width) is designed specifically for viewing on
              smartphones and tablets. The vertical layout ensures easy scrolling and readability on
              smaller screens.
            </p>
          ...
          <div className="glass-card p-8 card-shadow">
            ...
            <p className="text-muted-foreground mb-4">
              This traditional document format (210×297 mm) is perfect for formal reports, academic
              papers, and professional documents where a vertical orientation is preferred.
            </p>
