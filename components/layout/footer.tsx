          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
                Harness the power of AI to transform your text into professional infographics with
                one click. No design experience needed, 100% free.
              </p>
            </div>
          </div>
