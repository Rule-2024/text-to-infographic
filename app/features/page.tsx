    ...
    <main className="flex min-h-screen flex-col items-center p-4 sm:p-8 md:p-24 bg-gradient-to-b from-background to-muted">
      ...
      <div className="relative z-10 w-full max-w-5xl">
        ...
        <p className="mb-12 text-lg text-center text-muted-foreground max-w-3xl mx-auto">
          Discover the powerful features that make our free AI text to infographic tool the best
          choice for creating stunning visual content from your text, no login required.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <Link
            ...
            className="glass-card p-6 card-shadow hover:shadow-lg transition-all duration-300 group"
          >
            ...
            <p className="text-muted-foreground">
              Our AI analyzes your text to identify key points, relationships, and important data to
          ...
          >
            ...
            <p className="text-muted-foreground">
              Choose from various design styles and color schemes that best match your content and
              purpose.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Download your infographics in multiple formats including PNG, JPG, and PDF for
              different use cases.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Create infographics in various sizes including 16:9 for presentations, A4 for
              printing, and mobile-friendly vertical formats.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Our tool automatically detects and processes text in multiple languages to create
              infographics in your preferred language.
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Use our tool without creating an account. No registration, no login, just instant
