...
export const metadata: Metadata = {
  ...
  description:
    'Create infographics in multiple languages with our AI text to infographic tool. Automatic language detection and processing for global content creation.',
  keywords: [
    'ai text to infographic',
    'multilingual infographic',
    'text to infographic ai free',
    'language support infographic',
    'global infographic creator',
    'international infographic tool',
  ],
  alternates: {
...
export default function LanguageSupportLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <Script
