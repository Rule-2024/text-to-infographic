...
export const metadata: Metadata = {
  ...
  description:
    'Create infographics instantly with our free AI tool - no login, no registration, no experience needed. Convert text to infographics without creating an account.',
  keywords: [
    'ai text to infographic',
    'no login infographic maker',
    'text to infographic ai free',
    'infographic without registration',
    'free infographic generator',
    'no account infographic',
  ],
  alternates: {
...
export default function NoLoginLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <Script
