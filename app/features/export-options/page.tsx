    ...
    <main className="flex min-h-screen flex-col items-center p-4 sm:p-8 md:p-24 bg-gradient-to-b from-background to-muted">
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <p className="mb-6 text-lg text-muted-foreground">
          Download your AI-generated infographics in multiple formats to suit your specific needs,
          whether for digital sharing, presentations, or printing - all with our free text to
          infographic tool.
        </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  High-quality images with transparent background support. Ideal for digital use and
                  web publishing.
                </p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Compressed image format with smaller file sizes. Perfect for email attachments and
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Vector-based document format that maintains quality at any size. Ideal for
            ...
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row gap-4 items-center p-4 bg-blue-50 rounded-lg">
                ...
                <div className="w-full md:w-3/4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Perfect for presentations, digital displays, and video content. This widescreen
                    format is the standard for most modern screens and projectors.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center p-4 bg-green-50 rounded-lg">
                ...
                <div className="w-full md:w-3/4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Ideal for printed materials and documents. This standard paper size works well
                    for handouts, reports, and printed presentations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center p-4 bg-amber-50 rounded-lg">
                ...
                <div className="w-full md:w-3/4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Perfect for detailed infographics with vertical flow. Suitable for reports,
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center p-4 bg-purple-50 rounded-lg">
                ...
                <div className="w-full md:w-3/4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Optimized for mobile devices and social media stories. This vertical format is
                    perfect for sharing on Instagram, Facebook Stories, and other mobile platforms.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="glass-card p-8 card-shadow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-sm text-muted-foreground">
                  Generate a shareable link that allows others to view your infographic online
                  without downloading it. Perfect for quick sharing via email, messaging apps, or
                  social media.
                </p>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-sm text-muted-foreground">
                  Coming soon: Direct sharing to popular social media platforms with optimized
                  formatting for each platform. Share your infographics directly to Twitter,
