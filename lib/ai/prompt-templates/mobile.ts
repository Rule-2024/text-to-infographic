/**
 * 移动设备竖版提示词模板 (650×自适应)
 * 基于其他提示词但优化为更窄的移动设备竖版尺寸，提高移动端可读性
 */
...
## 【核心要求】
- **宽度限制**：固定宽度650px，确保在移动设备上有良好显示效果（比原来的750px更窄，更适合小屏幕）
- **高度自适应**：根据内容自动调整高度，不设固定限制
- **安全区域**：实际内容区域宽度为610px（左右预留20px边距）
...
## 设计任务
创建一张宽度为650px、高度自适应的响应式卡片，完整呈现以下文章的核心内容：
