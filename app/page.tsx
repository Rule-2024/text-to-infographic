...
export const metadata: Metadata = {
  ...
  description:
    'Create infographics from text instantly with our AI text visualization tool. Convert articles to visual infographics in seconds. Online infographic maker with multiple formats, no design skills needed, 100% free with no login required.',
  alternates: {
  ...
  keywords: [
    ...
    'infographic from text',
    'no login infographic',
  ],
  openGraph: {
    title: 'Text to Infographic | Free AI Tool to Create Infographics in Seconds',
    description:
  ...
  twitter: {
    ...
    title: 'Text to Infographic | Free AI Tool to Create Infographics in Seconds',
    description:
      'Create infographics from text instantly with our AI text visualization tool. The easiest way to convert text to visual infographics online. Free, no login required.',
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 md:p-24 pb-12 bg-gradient-to-b from-background to-muted">
      ...
      <div className="relative z-10 mb-8 md:mb-12 text-center px-4">
        <h1 className="mb-4 text-3xl font-bold tracking-tight md:text-6xl gradient-heading">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-sm text-muted-foreground">
          Transform articles, reports, essays, and any text into professional infographics in
          seconds
        </p>
      </div>

      <div className="relative z-10 flex flex-col items-center">
        <a href="/create" className="btn-gradient mb-8 text-lg">
          Start Creating
        </a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mt-8 mb-16 md:mb-24 px-4">
          <div className="glass-card p-6 card-shadow">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-2">
              Fast Text to Infographic Conversion
            </h3>
            <p className="text-muted-foreground">
              Generate professional infographics from text in seconds, not hours
            </p>
          </div>
          ...
          <div className="glass-card p-6 card-shadow">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-2">AI-Powered Infographic Design</h3>
            <p className="text-muted-foreground">
              Smart layouts and visuals that automatically enhance your content
            </p>
          </div>
          ...
          <div className="glass-card p-6 card-shadow">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-2">Free Infographic Generator</h3>
            <p className="text-muted-foreground">
              100% free to use with no account creation required
            </p>
          </div>
        </div>
        ...
        <div className="mt-0 mb-16 md:mb-24 max-w-5xl px-4">
          <h2 className="text-2xl md:text-4xl font-bold mb-6 md:mb-8 text-center gradient-heading">
            Explore Our Features
          </h2>
          <p className="text-center text-base md:text-lg text-muted-foreground mb-8 md:mb-12 max-w-3xl mx-auto">
            Discover the powerful features that make our AI text to infographic tool the best choice
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <a
              ...
              className="glass-card p-5 md:p-6 card-shadow hover:shadow-lg transition-all duration-300 group"
            >
              ...
              <p className="text-muted-foreground mb-4">
                Our AI analyzes your text to identify key points and important data
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Choose from various design styles and color schemes for your infographics
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Download your infographics in multiple formats including PNG, JPG, and PDF
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Create infographics in various sizes including 16:9, A4, and mobile formats
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Create infographics in multiple languages with automatic language detection
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-4">
                Use our tool without creating an account, just instant infographic creation
              </p>
        ...
        <div className="mt-0 mb-16 md:mb-24 max-w-4xl px-4">
          <h2 className="text-2xl md:text-4xl font-bold mb-8 md:mb-12 text-center gradient-heading">
            Why Choose Our Text to Infographic Tool?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="glass-card p-5 md:p-7 card-shadow">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-base md:text-lg font-semibold">Multiple Output Formats</h3>
              </div>
              <p className="text-muted-foreground">
                Export your infographics in PNG, JPG, and PDF formats
              </p>
            </div>
            <div className="glass-card p-5 md:p-7 card-shadow">
              <div className="flex items-center mb-3">
                <div className="w-10 h-10 mr-3 rounded-full bg-secondary/10 flex items-center justify-center">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M4 8V6a2 2 0 012-2h12a2 2 0 012 2v2M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M6 12h12"
                    />
                  </svg>
                </div>
                <h3 className="text-base md:text-lg font-semibold">Various Size Options</h3>
              </div>
              <p className="text-muted-foreground">
                Choose from 16:9, A4 landscape, A4 portrait, and mobile-friendly sizes
              </p>
            </div>
            <div className="glass-card p-5 md:p-7 card-shadow">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-base md:text-lg font-semibold">Supports All Languages</h3>
              </div>
            ...
            <div className="glass-card p-5 md:p-7 card-shadow">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-base md:text-lg font-semibold">No Design Skills Needed</h3>
              </div>
              <p className="text-muted-foreground">
                Our AI handles all the design work for you automatically
              </p>
            </div>
          </div>
        </div>
