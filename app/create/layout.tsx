...
export const metadata: Metadata = {
  ...
  description:
    'Convert your text into stunning infographics using our AI text to infographic tool. Transform articles, essays, and reports into visual content in seconds.',
  keywords: [
