      ...
      <div className="relative z-10 w-full max-w-4xl">
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Transform your text into stunning visual infographics in seconds with our AI-powered
            tool
          </p>
        </div>
        ...
        <div className="text-center mb-8 md:mb-16">
          <p className="text-sm text-muted-foreground">
            ...
            to unlock more features (coming soon)
          </p>
        </div>
            ...
            <div className="glass-card p-4 card-shadow">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Choose from various sizes and export formats for your needs
                  </p>
                </div>
              </div>
            </div>
