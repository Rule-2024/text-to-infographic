      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mt-8 mb-16 md:mb-24 px-4">
          <div className="glass-card p-6 card-shadow">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-2">Fast Text to Infographic Conversion</h3>
        ...
        <div className="mt-0 mb-16 md:mb-24 max-w-5xl px-4">
          <h2 className="text-2xl md:text-4xl font-bold mb-6 md:mb-8 text-center gradient-heading">Explore Our Features</h2>
        ...
        <div className="mt-0 mb-16 md:mb-24 max-w-4xl px-4">
          <h2 className="text-2xl md:text-4xl font-bold mb-8 md:mb-12 text-center gradient-heading">Why Choose Our Text to Infographic Tool?</h2>
